        ...
        <div className="lg:col-span-2 space-y-5">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
              ...
              <div className="mt-3">
                <Link href={`/tenant/${subdomain}/customers/new`} className="text-xs text-blue-600 hover:underline">
                  + Add new customer
                </Link>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3">
              <Link href={`/tenant/${subdomain}/loans`} className="px-5 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50">
                Cancel
              </Link>
              <button
                type="submit"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2.5 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{fmtCurrency(Number(form.principal))}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Total Interest</span>
                    <span className="font-medium text-orange-600">{fmtCurrency(totalInterest)}</span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{form.termMonths}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="h-3 rounded-full overflow-hidden flex">
                    <div
                      ...
                      style={{ width: `${(Number(form.principal) / totalRepayment) * 100}%` }}
                    />
