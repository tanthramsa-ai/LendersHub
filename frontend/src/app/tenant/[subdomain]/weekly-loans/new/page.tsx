            ...
            {selectedCustomer ? (
              ...
              <>
                ...
                {customerSearch.length > 2 && customerResults.length === 0 && !searching && (
                  <p className="text-sm text-gray-500 mt-2">No customers found. <button onClick={() => setShowAddCustomer(true)} className="text-blue-600 hover:underline">Add new customer</button></p>
                )}
              </>
            )}
